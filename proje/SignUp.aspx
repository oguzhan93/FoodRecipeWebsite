<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="proje.SignUp" %>
...
<body>
    ...
    <div class="form__container">
        <div class="login-form">
            ...
            <h1 style="font-size: 12px; margin-top: 12px;">Do you have already an account?   <a style="color: blue;" href="LogIn.aspx">  Log In</a></h1>
        </div>
    </div>
</body>
</html>
